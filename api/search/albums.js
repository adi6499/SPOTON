// ============================================================================
// MUSICFLOW — VERCEL SERVERLESS FUNCTION: JIOSAAVN SEARCH ALBUMS
// Endpoint: GET /api/search/albums?query=...&page=1&limit=20
// ============================================================================
...
module.exports = async function handler(req, res) {
  ...
  try {
    const results = await jiosaavnService.searchAlbums(query, page, limit);

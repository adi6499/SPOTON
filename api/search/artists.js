// ============================================================================
// MUSICFLOW — VERCEL SERVERLESS FUNCTION: JIOSAAVN SEARCH ARTISTS
// Endpoint: GET /api/search/artists?query=...&page=1&limit=20
// ============================================================================
...
module.exports = async function handler(req, res) {
  ...
  try {
    const results = await jiosaavnService.searchArtists(query, page, limit);

// ============================================================================
// MUSICFLOW — VERCEL SERVERLESS FUNCTION: JIOSAAVN SEARCH SONGS
// Endpoint: GET /api/search/songs?query=...&page=1&limit=20
// ============================================================================
...
module.exports = async function handler(req, res) {
  ...
  try {
    const results = await jiosaavnService.searchSongs(query, page, limit);
